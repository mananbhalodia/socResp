...
var DatePicker = function (_PureComponent) {
  ...
  function DatePicker(props) {
    ...
    _this.renderPopup = function (styling, isActive, popupShown) {
      ...
      var onRenderCalendar = _this$props.onRenderCalendar;
    ...
    _this.handleValidate = function (value, processedValue) {
      ...
      var pattern = _this$props2.pattern;
      var emptyChar = _this$props2.emptyChar;
  ...
  (0, _createClass3.default)(DatePicker, [{
    ...
    value: function render() {
      ...
      var registerInput = _props.registerInput;
      var getInputElement = _props.getInputElement;
