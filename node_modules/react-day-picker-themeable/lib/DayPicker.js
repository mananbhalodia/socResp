...
var DayPicker = function (_Component) {
  ...
  _createClass(DayPicker, [{
    ...
    value: function renderDayInMonth(day, month, styling) {
      var dayModifiers = [];
    ...
    value: function render() {
      ...
      var styling = (0, _createStylingFromTheme2.default)(this.props.theme, this.props.invertTheme);

      return _react2.default.createElement(
        'div',
        _extends({}, customProps, styling('dayPicker', this.props.locale, !this.props.onDayClick, this.props.className), {
          ref: 'dayPicker',
          role: 'application',
